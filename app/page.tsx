          ...
          <section className="hero">
            <div className="hero-left">
              ...
              <p className="hero-subtitle">
                Apollo Hub is an open-source productivity suite designed to deliver high-performance tools
                without compromising user security. It offers a privacy-first ecosystem where speed and
                transparency empower users to manage their workflows with total peace of mind.
              </p>
              ...
              <div className="hero-summary">
                ...
                <div className="hero-summary-row">
                  ...
                  <p className="hero-summary-text">
                    Apollo Hub is a high-performance, open-source productivity
                    suite built to give you total data sovereignty.
                  </p>
                </div>
                <div className="hero-summary-row">
                  ...
                  <p className="hero-summary-text">
                    ...
                    document system designed for secure and rapid content
                    creation.
                  </p>
                </div>
              </div>
